...
module.controller(
	'UserController',
	[ '$scope', '$routeParams', 'User', 'Messages', 'Session', 'Question', 'Conversation', 'Evnt', 'startConversation', 'makeDialog',
		function( $scope, $routeParams, User, Messages, Session, Question, Conversation, Evnt, startConversation, makeDialog ) {
...
var commonSignupLogic = function( $scope, user, search, Messages, $location, $q, Question, Answer, support ) {
	$scope.user = user;
...
module.controller(
	...
	[ '$scope', 'Session', 'Messages', '$location', '$q', 'Search', 'Question', 'Answer', '$modal',
		function( $scope, Session, Messages, $location, $q, Search, Question, Answer, $modal ) {
			$scope.Session = Session;
