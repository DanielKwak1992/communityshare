...
from community_share.app_exceptions import BadRequest, Forbidden, Unauthorized, NotFound, ServerError
...
def make_app():
    ...
    app.errorhandler(ServerError)(jsonify_with_code(HTTPStatus.INTERNAL_SERVER_ERROR))
